...
//	}
	...
	@Before("aop.aspects.MyPointcuts.allAddMethods()")   /* aop.UniLibrary.getBook() */
	public void beforeAddLoggingAdvice(JoinPoint joinPoint) {
		...
		System.out.println("beforeAddBookAdvice: логирование попытки получить книгу или журнал.");
		System.out.println("-------------------------");
	}
